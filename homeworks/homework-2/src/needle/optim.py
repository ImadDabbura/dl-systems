...
class SGD(Optimizer):
    ...
    def step(self):
        ...
        for param in self.params:
            ...
            self.u[param] = (
                self.momentum
                * self.u.setdefault(param, ndl.init.zeros(*param.grad.shape))
